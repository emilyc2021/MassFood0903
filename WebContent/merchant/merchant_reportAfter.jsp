...
<% List itemName=(ArrayList)request.getAttribute("itemName"); %>
<% List popItemTotal=(ArrayList)request.getAttribute("popItemTotal"); %>
...
<body>
<input type=hidden id="chart-data" data-orderamount="<%=orderamount %>" data-orderduring="<%=orderduring %>" data-item="<%=itemName %>" data-ItemTotal="<%=popItemTotal %>">
     ...
     <div class="container" id="AsideAndMain">
                    <div class="row align-items-start">
                        ...
                        <div class="col-lg-10" id="main">
							...
							<div class="form-inline mt-3">
								...
								<input type="hidden" name="AccountNumber" value="1">
                                ...
                                <hr style="border: 1px solid #EDE1D1; background-color: #EDE1D1;">
                                         ...
                                         <!-- 頁籤 -->
                                         <p class="text-center" style="color:#5B352C;font-size:20px;"> <%=orderMonth %></p>
                                        
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-chart1"
                                role="tab" aria-controls="nav-home" aria-selected="true">每日營收圖表</a>
                    ...
                    <div class="tab-content mb-3" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade m-auto" id="nav-chart2" role="tabpanel"
                            aria-labelledby="nav-profile-tab" style="position: relative;width:420px">
                            <p class="text-center mt-1" style="color:#5B352C;font-size:16px;"> 熱門餐點(銷售次數)</p>
