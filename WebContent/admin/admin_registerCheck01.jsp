					...
					<div>
						...
						<form METHOD="post"
							...
							<div class="form-group row mt-3">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control-plaintext"
										name="account" value="<%=consumerVO.getAccountNumber()%>">
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<input type="password" class="form-control-plaintext"
										name="password" value="<%=consumerVO.getPassword()%>">
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control-plaintext"
										name="address" value="<%=consumerVO.getAddress()%>" >
								</div>
							</div>
							<%
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control-plaintext"
										name="creditcard"
										value="<%=consumerVO.getCreditCardNumber()%>" >
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control-plaintext"
										name="creditdate"
										value="<%=consumerVO.getCreditCardExpirationDate()%>" >
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control-plaintext"
										name="creditcvv"
										value="<%=consumerVO.getCreditSecurityCode()%>" >
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control-plaintext" name="modify"
										value="<%=consumerVO.getLastUpdateDatetime()%>" >
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control-plaintext" name="admin"
										value="<%=consumerVO.getLastUpdateAccountNumber()%>" >
								</div>
							</div>
							...
							<div class="row justify-content-center">
							 ...
							 <input type="hidden" name="memberType" 	value="consumer">
