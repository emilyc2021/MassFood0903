...
<%-- 									<c:forEach var="M1" items="${list}" > --%>
										...
										<td><c:if test="${M1.status==0}">
												<a href="register.do1?name=consumer&account=${M1.accountNumber}&status=0" class="no"><i class="fas fa-times"></i></a>
											</c:if> <c:if test="${M1.status==1}">
												<a href="register.do1?name=consumer&account=${M1.accountNumber}&status=1"><i class="far fa-edit"></i></i></a>
											</c:if> <c:if test="${M1.status==2}">
												<a href="register.do1?name=consumer&account=${M1.accountNumber}&status=2" class="pass"><i
