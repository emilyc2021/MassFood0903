...
<body>
			...
			<div class="row align-items-start">
				...
				<div class="row col-lg-10">
					...
					<div class="col-lg-12">
						...
						<h1 class="title">新增管理員</h1>
					</div>
					<div id="addAdmin" class="ml-5">
						<form METHOD="post"
							ACTION="<%=request.getContextPath()%>/admin/adm.do1">
							<div class="form-group pt-1">
								<label class="pb-3" for="exampleInputEmail1">帳號：</label> <input
									type="email" class="form-control" id="email1" name="addEmail"
							...
							<div class="pb-1" style="text-align: center">
								<button type="submit"
									class="btn btn-outline-secondary btn-sm mt-4 signinbtn"
									id="submit1">送出新增</button>
		...
		<!-- JS檔 -->
<script src="./js/admin_insert.js"></script>
