					...
					<div>
						...
						<form METHOD="post"
							...
							<div class="form-group row">
								<label for="account" class="col-sm-4 col-form-label title">個人相片：</label>
								<div class="col-sm-6 align-self-center">
									<c:choose>
										<c:when test="<%=couriorVO.getPhoto() == null%>">
											<span>會員未上傳照片</span>
										</c:when>
										<c:otherwise>
											<img src="<%=couriorVO.getPhoto()%>" width="200" alt="未上傳照片">
										</c:otherwise>
									</c:choose>
								</div>
							</div>
							...
							<div class="form-group row mt-3">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control" name="account"
										value="<%=couriorVO.getAccountNumber()%>" readonly>
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control" name="password"
										value="<%=couriorVO.getPassword()%>" readonly>
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control" name="name"
										value="<%=couriorVO.getName()%>" readonly>
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control" name="id"
										value="<%=couriorVO.getIdentityNumber()%>" readonly>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control" name="phone"
										value="<%=couriorVO.getMobilePhone()%>" readonly>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control" name="address"
										value="<%=couriorVO.getAddress()%>" readonly>
								</div>
							</div>

							<div class="form-group row">
								<label for="address" class="col-sm-4 col-form-label title">外送區域：</label>
								<div class="col-sm-6">
							...
							<div class="form-group row">
								<label for="card" class="col-sm-4 col-form-label title">銀行代號：</label>
								<div class="col-sm-6">
									<input type="text" class="form-control" name="creditcard"
										value="<%=couriorVO.getBankCode()%>" readonly>
								</div>
							</div>
							<div class="form-group row">
								<label for="date" class="col-sm-4 col-form-label title">銀行帳號：</label>
								<div class="col-sm-6">
									<input type="text" class="form-control" name="creditdate"
										value="<%=couriorVO.getBankAccount()%>" readonly>
								</div>
							</div>
							<div class="form-group row">
								<label for="cvv" class="col-sm-4 col-form-label title">銀行戶名：</label>
								<div class="col-sm-6">
									<input type="text" class="form-control" name="creditcvv"
										value="<%=couriorVO.getBankAccountName()%>" readonly>
								</div>
							</div>
							...
							<div class="row justify-content-center">
								...
								<input type="hidden" name="action" value="CouriorUpdate">

								<input type="hidden" name="updateAdmin"
									value="${adminVO.accountNumber}">
							</div>
						</form>
					</div>
			</div>
