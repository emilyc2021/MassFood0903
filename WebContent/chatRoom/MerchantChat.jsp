...
<%
	...
	List<ChatRoomVO> findMessageContent = dao.findMessageContent(1,2); 
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="navbar-nav ml-auto mr-lg-5">
								...
								<li class="nav-item dropdown dropdown-lg no-caret"><a
									...
									style="font-size: 1.15em;">廠商專區</a> <i class="dropdown-arrow"></i>
									</a>
									<div
										...
										<div class=" row no-gutters">
											<div class="col-lg-6 p-lg-5">
												...
												<a class="dropdown-item" href="#">會員資料修改</a> <a
													class="dropdown-item" href="#">營業資訊</a>
												...
												<a class="dropdown-item" href="#">今日訂單</a> <a
													class="dropdown-item" href="#">歷史訂單</a>
												<div class="dropdown-divider border-0"></div>
											</div>
											<div class="col-lg-6 p-lg-5">
					...
					<div class="page-header-content">
						<div class="container text-center">
							<div class="row justify-content-center">
								<div class="col-lg-8">
									<h1 class="page-header-title mb-3 text-light">廠商專區</h1>
					...
					<div class="row align-items-start">
						...
						<div class="col-lg-2" id="aside">
							<ul class="cart">
								...
								<li><a href="#">申訴聊天室</a>
									<ul>
										<li><a href="<%=request.getContextPath()%>/MerchantChat.jsp">聯絡客服</a></li>
									</ul></li>
							</ul>
						</div>
							...
							<div class="chat" id="chat-container">
								...
								<div class="chat-message clearfix" id="chat-form">
									<input type="text" id="message-to-send"
										...
										name="action" value="merchant-insert">
