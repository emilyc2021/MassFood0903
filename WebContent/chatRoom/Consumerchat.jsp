...
<%
	...
	List<ChatRoomVO> findMessageContent = dao.findMessageContent(7,4);
						...
						<div class="col-lg-3" id="aside" style="height: 900px;">
							<ul class="cart">
								...
								<li><a href="#">好友系統</a>
									<ul>
										<li><a
											href='<%=request.getContextPath()%>/listAllFriend.jsp'>好友列表</a></li>
									</ul></li>
								<li><a href="#">申訴聊天室</a>
									<ul>
										<li><a href="<%=request.getContextPath()%>/Consumerchat.jsp">聯絡客服</a></li>
									</ul></li>
							</ul>
						</div>
							...
							<div class="chat" id="chat-container">
								...
								<div class="chat-message clearfix" id="chat-form">
									<input type="text" id="message-to-send"
										...
										name="action" value="consumer-insert">
